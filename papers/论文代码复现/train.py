...
from utils import accuracy, AvgrageMeter, CrossEntropyLabelSmooth, save_checkpoint, \
                    get_parameters, get_lastest_model
...
def get_args():
    ...
    parser.add_argument('--train-dir', type=str, default='E:/ImageNet/ILSVRC2012_img_train', help='path to training dataset')
    parser.add_argument('--val-dir', type=str, default='E:/ImageNet/ILSVRC2012_img_train_t3', help='path to validation dataset')
